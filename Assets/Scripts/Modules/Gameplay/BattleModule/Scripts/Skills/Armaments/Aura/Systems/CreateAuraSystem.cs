    ...
    public partial struct CreateAuraSystem : ISystem
    {
        public void OnUpdate(ref SystemState state) {
            ...
            foreach (var request in SystemAPI.Query<RefRO<CreateAura>>()) {
                ...
                ecb.AddComponent(aura, new Effects{ Ability = request.ValueRO.Skill });
                ecb.AddComponent(aura, new Statuses{ Ability = request.ValueRO.Skill });
                ecb.AddComponent(aura, new Stats{ Ability = request.ValueRO.Skill });
